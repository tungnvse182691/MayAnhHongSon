    ...
    <div className="bg-white text-black font-body selection:bg-black/10 min-h-screen">
      ...
      <main className="pb-12 w-full">
        ...
        <section className="relative w-full mb-16">
          <div className="relative w-full h-[60vh] md:h-[80vh] overflow-hidden flex flex-col items-center justify-center text-white bg-black">
            ...
            <div className="relative z-10 text-center max-w-4xl px-6">
               {/* Banner content remains empty per user preference, but container is full-bleed */}
            </div>
          </div>
        </section>
